...
# cache/02_dt_val_block.rds
# cache/02_dt_train_block.rds
# cache/02_dt_test_kmeans.rds
# cache/02_dt_val_kmeans.rds
# cache/02_dt_train_kmeans.rds
...
dt_test_block %>%
  filter(label != 0) %>%
  write_rds("cache/02_dt_test_block.rds")
dt_val_block %>%
  filter(label != 0) %>%
  write_rds("cache/02_dt_val_block.rds")
dt_train_block %>%
  filter(label != 0) %>%
  write_rds("cache/02_dt_train_block.rds")

dt_test_kmeans %>%
  write_rds("cache/02_dt_test_kmeans.rds")
dt_val_kmeans %>%
  write_rds("cache/02_dt_val_kmeans.rds")
dt_train_kmeans %>%
  write_rds("cache/02_dt_train_kmeans.rds")
